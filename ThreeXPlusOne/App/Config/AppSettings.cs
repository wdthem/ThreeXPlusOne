...
public class AppSettings
{
    ...
    {
        List<int> copyOfSeriesNumbers = AlgorithmSettings.ListOfSeriesNumbers;
...
public class AlgorithmSettings
{
    ...
    /// </summary>
    [AppSetting(description: $"A comma-separated list of numbers to run the program with. Overrides {nameof(NumberOfSeries)} and {nameof(MaxStartingNumber)}.", suggestedValue: "")]
