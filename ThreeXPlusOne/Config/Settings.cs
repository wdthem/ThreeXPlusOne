...
public class Settings
{
    ...
    /// </summary>
    [Setting(description: "Whether or not to generate the directed graph visualization of the data", suggestedValue: "true")]
    ...
    /// </summary>
    [Setting(description: "Whether or not to generate a file with metadata about the data used to create the visualization", suggestedValue: "true")]
